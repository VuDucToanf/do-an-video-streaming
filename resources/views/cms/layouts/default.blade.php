...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link rel="stylesheet" href="{{ asset('cms/css/morris.css') }}" type="text/css"/>
    <!-- calendar -->
    <link rel="stylesheet" href="{{ asset('cms/css/monthly.css') }}">
    <!-- //calendar -->
    <!-- //font-awesome icons -->
...
<!-- calendar -->
<script type="text/javascript" src="{{ asset('cms/js/monthly.js') }}"></script>
